...
and you'll get the response "alice", a newline, and "bob" (with no
ending newline).
...
can apply that diff to "friendlist.c".
...
"friendlist.c" that is already patched with "pt1.diff".
...
"friendlist.c" that is already patched with "pt1.diff" and "pt2.diff".
